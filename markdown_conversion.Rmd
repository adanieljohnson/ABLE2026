...
<center>![Downloading a gitHub archive](https://github.com/adanieljohnson/ABLE2026/blob/main/images/File_access.png?raw=true)</center>

<br>

1.  Go to the URL for the repository. The [URL for this presentation](https://github.com/adanieljohnson/ABLE2026) is `https://github.com/adanieljohnson/ABLE2026`.
...
<center>![Downloading a single GitHub file](https://github.com/adanieljohnson/ABLE2026/blob/main/images/Single_file.png?raw=true)</center>
...
<center>![Converting Markdown to Word format](https://github.com/adanieljohnson/ABLE2026/blob/main/images/Preview-Word-ABLE.png?raw=true)</center>
